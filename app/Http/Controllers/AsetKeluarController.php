...
public function editData(Request $request, $id)
{
    try {
        ...
        $relatedMaterials = Materials::whereIn('name', $nameValues)->get();
...
public function update(Request $request, $id)
{
    ...
    public function download($id)
    {
        ...
        $templateProcessor->setValue('date', $item->created_at->formatLocalized('%e %B %Y'));
    ...
    private function formatDate($dateString)
{
    ...
    // Define the Indonesian words for days, months, and years
...
private function formatYear($year)
{
    ...
    // Define the Indonesian words for digits and prefixes for thousands, hundreds, tens, and teens
    $digits = ['', 'Satu', 'Dua', 'Tiga', 'Empat', 'Lima', 'Enam', 'Tujuh', 'Delapan', 'Sembilan'];
    ...
    public function search(Request $request)
{
    ...
    $pageSize = 10;
        $asetkeluar = AsetKeluar::with(['asetskeluar'])
                            ...
                            // ->orWhere('aset', $asetsearch->id)
                            ->orWhereHas('asetskeluar', function ($q) use ($query) {
